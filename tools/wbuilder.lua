...
function TestVisible:paintTo(bb)
    ...
    RenderText:renderUtf8Text(
        ...
        "Visible screen size :  " .. (x_max - x_min) .. "x" .. (y_max - y_min),
        true
    )
    ...
    RenderText:renderUtf8Text(
        ...
        'Kobo Aura: 600 pixels/ 2.82 " = ' .. (600 / 2.82) .. " dpi",
        true
    )
end
...
local RIGHT_BUTTON_GROUP_WIDTH = 200
...
local Header = HorizontalGroup:new({
    ...
    HorizontalGroup:new({
        dimen = Geom:new({
            w = Screen.w - RIGHT_BUTTON_GROUP_WIDTH,
            h = HEADER_HEIGHT,
        }),
        IconButton:new({
            icon = "appbar.menu",
